...
import { GraphqlServerContext } from './GraphqlServerContext';
...
export type Mutation = {
  __typename?: 'Mutation';
  addSpend?: Maybe<Spend>;
};


export type MutationAddSpendArgs = {
...
export type ResolversTypes = ResolversObject<{
  ...
  Spend: ResolverTypeWrapper<Spend>;
...
export type MutationResolvers<ContextType = GraphqlServerContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  addSpend?: Resolver<Maybe<ResolversTypes['Spend']>, ParentType, ContextType, RequireFields<MutationAddSpendArgs, 'amount' | 'date' | 'platform'>>;
}>;
...
export type SpendResolvers<ContextType = GraphqlServerContext, ParentType extends ResolversParentTypes['Spend'] = ResolversParentTypes['Spend']> = ResolversObject<{
...
export type Resolvers<ContextType = GraphqlServerContext> = ResolversObject<{
  ...
  Spend?: SpendResolvers<ContextType>;
}>;
